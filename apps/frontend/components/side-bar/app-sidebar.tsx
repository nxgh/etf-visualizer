...
import { ArchiveX, Command, File, Inbox, Send, Trash2, ChartLine } from "lucide-react";
    ...
    <Sidebar collapsible="icon" className="overflow-hidden [&>[data-sidebar=sidebar]]:flex-row" {...props}>
      ...
      <Sidebar collapsible="none" className="hidden flex-1 md:flex">
        <SidebarHeader className="gap-3.5 border-b p-4">
          ...
          <SidebarInput placeholder="Type to search..." value={q ?? ""} onChange={(e) => setQuery(e.target.value)} onClear={() => setQuery(null)} />
        </SidebarHeader>
        <SidebarContent>
